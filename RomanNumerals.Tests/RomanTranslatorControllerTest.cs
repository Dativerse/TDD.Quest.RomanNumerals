...
public class RomanTranslatorControllerTest
{
    ...
    [TestCase(14 , "XIV", Description = "Complex case XIV when given 14")]
    [TestCase(19 , "XIX", Description = "Complex case XIX when given 19")]
    [TestCase(44 , "XLIV", Description = "Complex case XLIV when given 44")]
    [TestCase(49 , "XLIX", Description = "Complex case XLIX when given 49")]
    [TestCase(99 , "XCIX", Description = "Complex case XCIX when given 99")]
    [TestCase(135 , "CXXXV", Description = "Complex case CXXXV when given 135")]
    [TestCase(498 , "CDXCVIII", Description = "Complex case CDXCVIII when given 498")]
    [TestCase(952 , "CMLII", Description = "Complex case CMLII when given 952")]
    [TestCase(1345 , "MCCCXLV", Description = "Complex case MCCCXLV when given 1345")]
    [TestCase(2457 , "MMCDLVII", Description = "Complex case MMCDLVII when given 2457")]
    [TestCase(2986 , "MMCMLXXXVI", Description = "Complex case MMCMLXXXVI when given 2986")]
    [TestCase(3456 , "MMMCDLVI", Description = "Complex case MMMCDLVI when given 3456")]
